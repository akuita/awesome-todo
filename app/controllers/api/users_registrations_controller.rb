class Api::UsersRegistrationsController < Api::BaseController
  def create
    ...
    return render json: { message: I18n.t('devise.failure.already_authenticated') }, status: :unprocessable_entity if User.exists?(email: @user.email)
    ...
    if @user.save
      if Rails.env.staging?
        ...
        render json: { message: I18n.t('devise.registrations.signed_up_but_unconfirmed') }, status: :ok and return
      end
    else
